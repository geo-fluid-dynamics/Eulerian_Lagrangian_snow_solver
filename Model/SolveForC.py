...
def solve_for_c(T, T_prev, phi, k_eff, rhoC_eff, D_eff, rho_v, rho_v_dT, v,v_dz, nz, dt, dz):
    '''
    Computes deposition rate c [kg/m^3/s]
    EQU : 72 from Hansen -> c = d/dz(D_eff * rho_v_dT dT/dz) - (1-phi) *rho_v_dT * dT/dt [- rho_v^eq * nabla (phi * v)] <- last term in square brackets results from incorporation of settling velocity
