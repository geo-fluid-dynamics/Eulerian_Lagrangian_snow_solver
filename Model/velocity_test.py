...
class TestVelocity(unittest.TestCase):
    def test_choose_viscosity(self):
        eta_const = velocity.choose_viscosity(263, 0.1125, 'eta_constant')
        self.assertEqual(eta_const,eta_0 * rho_i * 0.1125/c_eta * np.exp(a_eta *(T_fus - 263)+ b_eta *rho_i * 0.1125) )
    ...
    def test_sigma_cont_croc(self):
        sigma = velocity.sigma_cont_croc(np.array([0.25,0.25]), np.array([200,100,100]),3, v_opt='crocus')
